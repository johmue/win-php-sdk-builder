...
7za x %DIR%\downloads\php-5.5.15.tar -o%DIR%\phpdev\vc11\x64 -y

REM @ECHO cloning php-src repository from github...
REM git clone -b "PHP-5.5.15" https://github.com/php/php-src.git php-5.5.15
...
@ECHO @ECHO OFF> compile-php-5.5.15-nts-x64.bat
...
@ECHO @ECHO OFF> compile-php-5.5.15-ts-x64.bat
