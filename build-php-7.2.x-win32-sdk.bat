...
7za x %DIR%\downloads\php-7.2.0RC2.tar -o%DIR%\phpdev\vc15\x86 -y

@REM rename 7.2.0RC2 to 7.2.0RC2
@REM MOVE %DIR%\phpdev\vc15\x86\php-7.2.0RC2 %DIR%\phpdev\vc15\x86\php-7.2.0RC2
...
@ECHO @ECHO OFF> compile-php-7.2.0RC2-nts-x32.bat
@ECHO @ECHO ####################################################>> compile-php-7.2.0RC2-nts-x32.bat
@ECHO @ECHO ## Attention                                      ##>> compile-php-7.2.0RC2-nts-x32.bat
@ECHO @ECHO ## please call this batch file with               ##>> compile-php-7.2.0RC2-nts-x32.bat
@ECHO @ECHO ## Visual Studio 2015 Native Tools Command Prompt ##>> compile-php-7.2.0RC2-nts-x32.bat
@ECHO @ECHO ## the standard Windows CLI will not work         ##>> compile-php-7.2.0RC2-nts-x32.bat
@ECHO @ECHO ####################################################>> compile-php-7.2.0RC2-nts-x32.bat
@ECHO.>>compile-php-7.2.0RC2-nts-x32.bat
@ECHO PAUSE>> compile-php-7.2.0RC2-nts-x32.bat
@ECHO call .\bin\phpsdk_setvars.bat>> compile-php-7.2.0RC2-nts-x32.bat
@ECHO CD .\phpdev\vc15\x86\php-7.2.0RC2>> compile-php-7.2.0RC2-nts-x32.bat
@ECHO nmake clean>> compile-php-7.2.0RC2-nts-x32.bat
@ECHO call buildconf.bat --force>> compile-php-7.2.0RC2-nts-x32.bat
@ECHO call configure %CFLAGS% --disable-zts>> compile-php-7.2.0RC2-nts-x32.bat
@ECHO nmake snap /I>> compile-php-7.2.0RC2-nts-x32.bat
@ECHO CD .\..\..\..\..\>> compile-php-7.2.0RC2-nts-x32.bat
@ECHO PAUSE>> compile-php-7.2.0RC2-nts-x32.bat

@ECHO @ECHO OFF> compile-php-7.2.0RC2-ts-x32.bat
@ECHO @ECHO ####################################################>> compile-php-7.2.0RC2-ts-x32.bat
@ECHO @ECHO ## Attention                                      ##>> compile-php-7.2.0RC2-ts-x32.bat
@ECHO @ECHO ## please call this batch file with               ##>> compile-php-7.2.0RC2-ts-x32.bat
@ECHO @ECHO ## Visual Studio 2015 Native Tools Command Prompt ##>> compile-php-7.2.0RC2-ts-x32.bat
@ECHO @ECHO ## the standard Windows CLI will not work         ##>> compile-php-7.2.0RC2-ts-x32.bat
@ECHO @ECHO ####################################################>> compile-php-7.2.0RC2-ts-x32.bat
@ECHO.>>compile-php-7.2.0RC2-ts-x32.bat
@ECHO PAUSE>> compile-php-7.2.0RC2-ts-x32.bat
@ECHO call .\bin\phpsdk_setvars.bat>> compile-php-7.2.0RC2-ts-x32.bat
@ECHO CD .\phpdev\vc15\x86\php-7.2.0RC2>> compile-php-7.2.0RC2-ts-x32.bat
@ECHO nmake clean>> compile-php-7.2.0RC2-ts-x32.bat
@ECHO call buildconf.bat --force>> compile-php-7.2.0RC2-ts-x32.bat
@ECHO call configure %CFLAGS%>> compile-php-7.2.0RC2-ts-x32.bat
@ECHO nmake snap /I>> compile-php-7.2.0RC2-ts-x32.bat
@ECHO CD .\..\..\..\..\>> compile-php-7.2.0RC2-ts-x32.bat
@ECHO PAUSE>> compile-php-7.2.0RC2-ts-x32.bat
