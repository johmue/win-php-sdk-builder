...
IF NOT EXIST "%DIR%\downloads\deps-master-vc15-x86.7z" (
    @ECHO.
    @ECHO loading php dependencies...
    wget http://windows.php.net/downloads/php-sdk/deps-master-vc15-x86.7z -O %DIR%\downloads\deps-master-vc15-x86.7z -N
)
...
7za x %DIR%\downloads\deps-master-vc15-x86.7z -o%DIR%\phpdev\vc15\x86 -y

REM IF NOT EXIST "%SystemRoot%\System32\vcruntime140.dll" (
    REM @ECHO.
    REM @ECHO MS visual c redistributable dll not found in system path
    REM @ECHO possible problem for compiling
    REM @ECHO grab an up-2-date version of vcruntime140.dll from MS
    REM @ECHO http://www.microsoft.com/en-us/download/details.aspx?id=30679
    REM PAUSE
REM )

REM IF EXIST "%SystemRoot%\System32\vcruntime140.dll" (
    REM @ECHO.
    REM @ECHO copying ms visual c redistributable dll from system path...
    REM COPY "%SystemRoot%\System32\vcruntime140.dll" "%DIR%\phpdev\vc15\x86\deps\bin\"
REM )

REM IF NOT EXIST "%SystemRoot%\System32\vcruntime140d.dll" (
    REM @ECHO.
    REM @ECHO MS visual c redistributable dll not found in system path
    REM @ECHO possible problem for compiling
    REM @ECHO grab an up-2-date version of vcruntime140d.dll from MS
    REM @ECHO http://www.microsoft.com/en-us/download/details.aspx?id=30679
    REM PAUSE
REM )

REM IF EXIST "%SystemRoot%\System32\vcruntime140d.dll" (
    REM @ECHO.
    REM @ECHO copying ms visual c redistributable dll from system path...
    REM COPY "%SystemRoot%\System32\vcruntime140d.dll" "%DIR%\phpdev\vc15\x86\deps\bin\"
REM )
...
7za x %DIR%\downloads\php-7.2.0beta1.tar -o%DIR%\phpdev\vc15\x86 -y

@REM rename 7.2.0beta1 to 7.2.0beta1
@REM MOVE %DIR%\phpdev\vc15\x86\php-7.2.0beta1 %DIR%\phpdev\vc15\x86\php-7.2.0beta1

REM @ECHO cloning php-src repository from github...
REM CD %DIR%\phpdev\vc15\x86
...
IF /I %BUILDEXT_EXCEL%==Y (
    call %DIR%\ext\php_excel_7.2.x_x86.bat
...
IF /I %BUILDEXT_LZ4%==Y (
    call %DIR%\ext\php_lz4_7.2.x_x86.bat
...
@ECHO @ECHO OFF> compile-php-7.2.0beta1-nts-x32.bat
@ECHO @ECHO ####################################################>> compile-php-7.2.0beta1-nts-x32.bat
@ECHO @ECHO ## Attention                                      ##>> compile-php-7.2.0beta1-nts-x32.bat
@ECHO @ECHO ## please call this batch file with               ##>> compile-php-7.2.0beta1-nts-x32.bat
@ECHO @ECHO ## Visual Studio 2015 Native Tools Command Prompt ##>> compile-php-7.2.0beta1-nts-x32.bat
@ECHO @ECHO ## the standard Windows CLI will not work         ##>> compile-php-7.2.0beta1-nts-x32.bat
@ECHO @ECHO ####################################################>> compile-php-7.2.0beta1-nts-x32.bat
@ECHO.>>compile-php-7.2.0beta1-nts-x32.bat
@ECHO PAUSE>> compile-php-7.2.0beta1-nts-x32.bat
@ECHO call .\bin\phpsdk_setvars.bat>> compile-php-7.2.0beta1-nts-x32.bat
@ECHO CD .\phpdev\vc15\x86\php-7.2.0beta1>> compile-php-7.2.0beta1-nts-x32.bat
@ECHO nmake clean>> compile-php-7.2.0beta1-nts-x32.bat
@ECHO call buildconf.bat --force>> compile-php-7.2.0beta1-nts-x32.bat
@ECHO call configure %CFLAGS% --disable-zts>> compile-php-7.2.0beta1-nts-x32.bat
@ECHO nmake snap /I>> compile-php-7.2.0beta1-nts-x32.bat
@ECHO CD .\..\..\..\..\>> compile-php-7.2.0beta1-nts-x32.bat
@ECHO PAUSE>> compile-php-7.2.0beta1-nts-x32.bat

@ECHO @ECHO OFF> compile-php-7.2.0beta1-ts-x32.bat
@ECHO @ECHO ####################################################>> compile-php-7.2.0beta1-ts-x32.bat
@ECHO @ECHO ## Attention                                      ##>> compile-php-7.2.0beta1-ts-x32.bat
@ECHO @ECHO ## please call this batch file with               ##>> compile-php-7.2.0beta1-ts-x32.bat
@ECHO @ECHO ## Visual Studio 2015 Native Tools Command Prompt ##>> compile-php-7.2.0beta1-ts-x32.bat
@ECHO @ECHO ## the standard Windows CLI will not work         ##>> compile-php-7.2.0beta1-ts-x32.bat
@ECHO @ECHO ####################################################>> compile-php-7.2.0beta1-ts-x32.bat
@ECHO.>>compile-php-7.2.0beta1-ts-x32.bat
@ECHO PAUSE>> compile-php-7.2.0beta1-ts-x32.bat
@ECHO call .\bin\phpsdk_setvars.bat>> compile-php-7.2.0beta1-ts-x32.bat
@ECHO CD .\phpdev\vc15\x86\php-7.2.0beta1>> compile-php-7.2.0beta1-ts-x32.bat
@ECHO nmake clean>> compile-php-7.2.0beta1-ts-x32.bat
@ECHO call buildconf.bat --force>> compile-php-7.2.0beta1-ts-x32.bat
@ECHO call configure %CFLAGS%>> compile-php-7.2.0beta1-ts-x32.bat
@ECHO nmake snap /I>> compile-php-7.2.0beta1-ts-x32.bat
@ECHO CD .\..\..\..\..\>> compile-php-7.2.0beta1-ts-x32.bat
@ECHO PAUSE>> compile-php-7.2.0beta1-ts-x32.bat
