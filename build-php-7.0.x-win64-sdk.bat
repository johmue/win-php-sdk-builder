...
REM IF NOT EXIST "%DIR%\downloads\php-7.0.0.tar.bz2" (
    REM @ECHO.
    REM @ECHO loading php source code...
    REM wget http://de1.php.net/get/php-7.0.0.tar.bz2/from/this/mirror -O %DIR%\downloads\php-7.0.0.tar.bz2 -N
REM )

REM IF NOT EXIST "%DIR%\downloads\php-7.0.0.tar.bz2" (
    REM @ECHO.
    REM @ECHO php source code not found in .\downloads please re-run this script
    REM PAUSE
    REM EXIT
REM )

REM IF NOT EXIST "%DIR%\downloads\php-7.0.0.tar" (
    REM 7za x %DIR%\downloads\php-7.0.0.tar.bz2 -o%DIR%\downloads -y
REM )
...
REM @ECHO.
REM @ECHO unpacking php source code...
...
@ECHO @ECHO OFF> compile-php-7.0.0-nts-x64.bat
@ECHO @ECHO ####################################################>> compile-php-7.0.0-nts-x64.bat
@ECHO @ECHO ## Attention                                      ##>> compile-php-7.0.0-nts-x64.bat
@ECHO @ECHO ## please call this batch file with               ##>> compile-php-7.0.0-nts-x64.bat
@ECHO @ECHO ## Visual Studio 2012 Native Tools Command Prompt ##>> compile-php-7.0.0-nts-x64.bat
@ECHO @ECHO ## the standard Windows CLI will not work         ##>> compile-php-7.0.0-nts-x64.bat
@ECHO @ECHO ####################################################>> compile-php-7.0.0-nts-x64.bat
@ECHO.>>compile-php-7.0.0-nts-x64.bat
@ECHO PAUSE>> compile-php-7.0.0-nts-x64.bat
@ECHO call .\bin\phpsdk_setvars.bat>> compile-php-7.0.0-nts-x64.bat
@ECHO CD .\phpdev\vc11\x64\php-7.0.0>> compile-php-7.0.0-nts-x64.bat
@ECHO nmake clean>> compile-php-7.0.0-nts-x64.bat
@ECHO call buildconf.bat --force>> compile-php-7.0.0-nts-x64.bat
@ECHO call configure %CFLAGS% --disable-zts>> compile-php-7.0.0-nts-x64.bat
@ECHO nmake snap>> compile-php-7.0.0-nts-x64.bat
@ECHO CD .\..\..\..\..\>> compile-php-7.0.0-nts-x64.bat
@ECHO PAUSE>> compile-php-7.0.0-nts-x64.bat

@ECHO @ECHO OFF> compile-php-7.0.0-ts-x64.bat
@ECHO @ECHO ####################################################>> compile-php-7.0.0-ts-x64.bat
@ECHO @ECHO ## Attention                                      ##>> compile-php-7.0.0-ts-x64.bat
@ECHO @ECHO ## please call this batch file with               ##>> compile-php-7.0.0-ts-x64.bat
@ECHO @ECHO ## Visual Studio 2012 Native Tools Command Prompt ##>> compile-php-7.0.0-ts-x64.bat
@ECHO @ECHO ## the standard Windows CLI will not work         ##>> compile-php-7.0.0-ts-x64.bat
@ECHO @ECHO ####################################################>> compile-php-7.0.0-ts-x64.bat
@ECHO.>>compile-php-7.0.0-ts-x64.bat
@ECHO PAUSE>> compile-php-7.0.0-ts-x64.bat
@ECHO call .\bin\phpsdk_setvars.bat>> compile-php-7.0.0-ts-x64.bat
@ECHO CD .\phpdev\vc11\x64\php-7.0.0>> compile-php-7.0.0-ts-x64.bat
@ECHO nmake clean>> compile-php-7.0.0-ts-x64.bat
@ECHO call buildconf.bat --force>> compile-php-7.0.0-ts-x64.bat
@ECHO call configure %CFLAGS%>> compile-php-7.0.0-ts-x64.bat
@ECHO nmake snap>> compile-php-7.0.0-ts-x64.bat
@ECHO CD .\..\..\..\..\>> compile-php-7.0.0-ts-x64.bat
@ECHO PAUSE>> compile-php-7.0.0-ts-x64.bat
