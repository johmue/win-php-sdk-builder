...
7za x %DIR%\downloads\php-7.0.17.tar -o%DIR%\phpdev\vc14\x64 -y

@REM rename 7.0.17 to 7.0.17
MOVE %DIR%\phpdev\vc14\x64\php-7.0.17 %DIR%\phpdev\vc14\x64\php-7.0.17
...
@ECHO @ECHO OFF> compile-php-7.0.17-nts-x64.bat
@ECHO @ECHO ####################################################>> compile-php-7.0.17-nts-x64.bat
@ECHO @ECHO ## Attention                                      ##>> compile-php-7.0.17-nts-x64.bat
@ECHO @ECHO ## please call this batch file with               ##>> compile-php-7.0.17-nts-x64.bat
@ECHO @ECHO ## Visual Studio 2015 Native Tools Command Prompt ##>> compile-php-7.0.17-nts-x64.bat
@ECHO @ECHO ## the standard Windows CLI will not work         ##>> compile-php-7.0.17-nts-x64.bat
@ECHO @ECHO ####################################################>> compile-php-7.0.17-nts-x64.bat
@ECHO.>>compile-php-7.0.17-nts-x64.bat
@ECHO PAUSE>> compile-php-7.0.17-nts-x64.bat
@ECHO call .\bin\phpsdk_setvars.bat>> compile-php-7.0.17-nts-x64.bat
@ECHO CD .\phpdev\vc14\x64\php-7.0.17>> compile-php-7.0.17-nts-x64.bat
@ECHO nmake clean>> compile-php-7.0.17-nts-x64.bat
@ECHO call buildconf.bat --force>> compile-php-7.0.17-nts-x64.bat
@ECHO call configure %CFLAGS% --disable-zts>> compile-php-7.0.17-nts-x64.bat
@ECHO nmake snap /I>> compile-php-7.0.17-nts-x64.bat
@ECHO CD .\..\..\..\..\>> compile-php-7.0.17-nts-x64.bat
@ECHO PAUSE>> compile-php-7.0.17-nts-x64.bat

@ECHO @ECHO OFF> compile-php-7.0.17-ts-x64.bat
@ECHO @ECHO ####################################################>> compile-php-7.0.17-ts-x64.bat
@ECHO @ECHO ## Attention                                      ##>> compile-php-7.0.17-ts-x64.bat
@ECHO @ECHO ## please call this batch file with               ##>> compile-php-7.0.17-ts-x64.bat
@ECHO @ECHO ## Visual Studio 2015 Native Tools Command Prompt ##>> compile-php-7.0.17-ts-x64.bat
@ECHO @ECHO ## the standard Windows CLI will not work         ##>> compile-php-7.0.17-ts-x64.bat
@ECHO @ECHO ####################################################>> compile-php-7.0.17-ts-x64.bat
@ECHO.>>compile-php-7.0.17-ts-x64.bat
@ECHO PAUSE>> compile-php-7.0.17-ts-x64.bat
@ECHO call .\bin\phpsdk_setvars.bat>> compile-php-7.0.17-ts-x64.bat
@ECHO CD .\phpdev\vc14\x64\php-7.0.17>> compile-php-7.0.17-ts-x64.bat
@ECHO nmake clean>> compile-php-7.0.17-ts-x64.bat
@ECHO call buildconf.bat --force>> compile-php-7.0.17-ts-x64.bat
@ECHO call configure %CFLAGS%>> compile-php-7.0.17-ts-x64.bat
@ECHO nmake snap /I>> compile-php-7.0.17-ts-x64.bat
@ECHO CD .\..\..\..\..\>> compile-php-7.0.17-ts-x64.bat
@ECHO PAUSE>> compile-php-7.0.17-ts-x64.bat
