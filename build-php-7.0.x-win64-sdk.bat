...
IF NOT EXIST "%DIR%\downloads\deps-7.0-vc14-x64.7z" (
    @ECHO.
    @ECHO loading php dependencies...
    wget http://windows.php.net/downloads/php-sdk/deps-7.0-vc14-x64.7z -O %DIR%\downloads\deps-7.0-vc14-x64.7z -N
)
...
7za x %DIR%\downloads\deps-7.0-vc14-x64.7z -o%DIR%\phpdev\vc14\x64 -y
...
IF NOT EXIST "%DIR%\downloads\php-7.0.9.tar.bz2" (
    @ECHO.
    @ECHO loading php source code...
    REM wget http://de1.php.net/get/php-7.0.9.tar.bz2/from/this/mirror -O %DIR%\downloads\php-7.0.9.tar.bz2 -N
    REM wget https://downloads.php.net/~ab/php-7.0.9.tar.bz2 -O %DIR%\downloads\php-7.0.9.tar.bz2 -N --no-check-certificate
    wget http://de1.php.net/get/php-7.0.9.tar.bz2/from/this/mirror -O %DIR%\downloads\php-7.0.9.tar.bz2 -N --no-check-certificate
)
...
IF NOT EXIST "%DIR%\downloads\php-7.0.9.tar" (
    7za x %DIR%\downloads\php-7.0.9.tar.bz2 -o%DIR%\downloads -y
)
...
7za x %DIR%\downloads\php-7.0.9.tar -o%DIR%\phpdev\vc14\x64 -y

@REM rename 7.0.9 to 7.0.9
MOVE %DIR%\phpdev\vc14\x64\php-7.0.9 %DIR%\phpdev\vc14\x64\php-7.0.9

REM @ECHO cloning php-src repository from github...
REM CD %DIR%\phpdev\vc14\x64
REM git clone --branch=master --depth=1 https://github.com/php/php-src.git php-7.0.9

CD %DIR%

REM SET CFLAGS=--disable-all --enable-cli --enable-snapshot-build --enable-debug --enable-object-out-dir=../obj_7.0.9/ --disable-isapi --disable-nsapi
SET CFLAGS=--disable-all --enable-cli --enable-snapshot-build --enable-object-out-dir=../obj_7.0.9/
...
IF /I %BUILDEXT_EXCEL%==Y (
    call %DIR%\ext\php_excel_7.0.x_x64.bat
...
IF /I %BUILDEXT_LZ4%==Y (
    call %DIR%\ext\php_lz4_7.0.x_x64.bat
...
REM IF /I %BUILDEXT_TWIG%==Y (
    REM call %DIR%\ext\php_twig_7.0.x_x64.bat
...
@ECHO @ECHO OFF> compile-php-7.0.9-nts-x64.bat
@ECHO @ECHO ####################################################>> compile-php-7.0.9-nts-x64.bat
@ECHO @ECHO ## Attention                                      ##>> compile-php-7.0.9-nts-x64.bat
@ECHO @ECHO ## please call this batch file with               ##>> compile-php-7.0.9-nts-x64.bat
@ECHO @ECHO ## Visual Studio 2015 Native Tools Command Prompt ##>> compile-php-7.0.9-nts-x64.bat
@ECHO @ECHO ## the standard Windows CLI will not work         ##>> compile-php-7.0.9-nts-x64.bat
@ECHO @ECHO ####################################################>> compile-php-7.0.9-nts-x64.bat
@ECHO.>>compile-php-7.0.9-nts-x64.bat
@ECHO PAUSE>> compile-php-7.0.9-nts-x64.bat
@ECHO call .\bin\phpsdk_setvars.bat>> compile-php-7.0.9-nts-x64.bat
@ECHO CD .\phpdev\vc14\x64\php-7.0.9>> compile-php-7.0.9-nts-x64.bat
@ECHO nmake clean>> compile-php-7.0.9-nts-x64.bat
@ECHO call buildconf.bat --force>> compile-php-7.0.9-nts-x64.bat
@ECHO call configure %CFLAGS% --disable-zts>> compile-php-7.0.9-nts-x64.bat
@ECHO nmake snap /I>> compile-php-7.0.9-nts-x64.bat
@ECHO CD .\..\..\..\..\>> compile-php-7.0.9-nts-x64.bat
@ECHO PAUSE>> compile-php-7.0.9-nts-x64.bat

@ECHO @ECHO OFF> compile-php-7.0.9-ts-x64.bat
@ECHO @ECHO ####################################################>> compile-php-7.0.9-ts-x64.bat
@ECHO @ECHO ## Attention                                      ##>> compile-php-7.0.9-ts-x64.bat
@ECHO @ECHO ## please call this batch file with               ##>> compile-php-7.0.9-ts-x64.bat
@ECHO @ECHO ## Visual Studio 2015 Native Tools Command Prompt ##>> compile-php-7.0.9-ts-x64.bat
@ECHO @ECHO ## the standard Windows CLI will not work         ##>> compile-php-7.0.9-ts-x64.bat
@ECHO @ECHO ####################################################>> compile-php-7.0.9-ts-x64.bat
@ECHO.>>compile-php-7.0.9-ts-x64.bat
@ECHO PAUSE>> compile-php-7.0.9-ts-x64.bat
@ECHO call .\bin\phpsdk_setvars.bat>> compile-php-7.0.9-ts-x64.bat
@ECHO CD .\phpdev\vc14\x64\php-7.0.9>> compile-php-7.0.9-ts-x64.bat
@ECHO nmake clean>> compile-php-7.0.9-ts-x64.bat
@ECHO call buildconf.bat --force>> compile-php-7.0.9-ts-x64.bat
@ECHO call configure %CFLAGS%>> compile-php-7.0.9-ts-x64.bat
@ECHO nmake snap /I>> compile-php-7.0.9-ts-x64.bat
@ECHO CD .\..\..\..\..\>> compile-php-7.0.9-ts-x64.bat
@ECHO PAUSE>> compile-php-7.0.9-ts-x64.bat
