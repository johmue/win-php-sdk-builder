...
CD %DIR%\phpdev\vc11\x64\php-5.5.13\ext

@ECHO.
@ECHO cloning php_excel repository...
git clone https://github.com/iliaal/php_excel.git
CD %DIR%\phpdev\vc11\x64\php-5.5.13\ext\php_excel
...
7za x %DIR%\downloads\libxl-win-3.5.4.zip -o%DIR%\phpdev\vc11\x64\php-5.5.13\ext\php_excel -y
CD %DIR%\phpdev\vc11\x64\php-5.5.13\ext\php_excel
