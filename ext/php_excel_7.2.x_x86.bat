...
CD %DIR%\phpdev\vc15\x86\php-7.2.0RC2\ext

@ECHO.
@ECHO cloning php_excel repository...
git clone https://github.com/johmue/php_excel.git
CD %DIR%\phpdev\vc15\x86\php-7.2.0RC2\ext\php_excel
...
7za x %DIR%\downloads\libxl-win-3.8.1.0.zip -o%DIR%\phpdev\vc15\x86\php-7.2.0RC2\ext\php_excel -y
CD %DIR%\phpdev\vc15\x86\php-7.2.0RC2\ext\php_excel
