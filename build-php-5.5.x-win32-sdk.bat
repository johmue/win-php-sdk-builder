...
IF NOT EXIST "%DIR%\downloads\php-5.5.15.tar.bz2" (
    @ECHO.
    @ECHO loading php source code...
    wget http://de1.php.net/get/php-5.5.15.tar.bz2/from/this/mirror -O %DIR%\downloads\php-5.5.15.tar.bz2 -N
)
...
IF NOT EXIST "%DIR%\downloads\php-5.5.15.tar" (
    7za x %DIR%\downloads\php-5.5.15.tar.bz2 -o%DIR%\downloads -y
)
...
7za x %DIR%\downloads\php-5.5.15.tar -o%DIR%\phpdev\vc11\x86 -y

REM @ECHO cloning php-src repository from github...
REM git clone --depth=1 -b "PHP-5.5.15" https://github.com/php/php-src.git php-5.5.15

CD %DIR%

REM SET CFLAGS=--disable-all --enable-cli --enable-snapshot-build --enable-debug-pack --enable-object-out-dir=../obj_5.5.15/ --disable-isapi --disable-nsapi
SET CFLAGS=--disable-all --enable-cli --enable-snapshot-build --enable-object-out-dir=../obj_5.5.15/ --disable-isapi --disable-nsapi
...
@ECHO @ECHO OFF> compile-php-5.5.15-nts-x32.bat
...
@ECHO call buildconf.bat --force>> compile-php-5.5.15-nts-x32.bat
@ECHO call configure %CFLAGS% --disable-zts>> compile-php-5.5.15-nts-x32.bat
@ECHO nmake snap>> compile-php-5.5.15-nts-x32.bat
@ECHO CD .\..\..\..\..\>> compile-php-5.5.15-nts-x32.bat
@ECHO PAUSE>> compile-php-5.5.15-nts-x32.bat

@ECHO @ECHO OFF> compile-php-5.5.15-ts-x32.bat
...
@ECHO call buildconf.bat --force>> compile-php-5.5.15-ts-x32.bat
@ECHO call configure %CFLAGS%>> compile-php-5.5.15-ts-x32.bat
@ECHO nmake snap>> compile-php-5.5.15-ts-x32.bat
@ECHO CD .\..\..\..\..\>> compile-php-5.5.15-ts-x32.bat
@ECHO PAUSE>> compile-php-5.5.15-ts-x32.bat
