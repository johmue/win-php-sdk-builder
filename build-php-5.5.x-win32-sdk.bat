...
7za x %DIR%\downloads\php-5.5.23.tar -o%DIR%\phpdev\vc11\x86 -y

REM @ECHO cloning php-src repository from github...
REM git clone --depth=1 -b "PHP-5.5.23" https://github.com/php/php-src.git php-5.5.23
...
@ECHO @ECHO OFF> compile-php-5.5.23-nts-x32.bat
@ECHO @ECHO ####################################################>> compile-php-5.5.23-nts-x32.bat
@ECHO @ECHO ## Attention                                      ##>> compile-php-5.5.23-nts-x32.bat
@ECHO @ECHO ## please call this batch file with               ##>> compile-php-5.5.23-nts-x32.bat
@ECHO @ECHO ## Visual Studio 2012 Native Tools Command Prompt ##>> compile-php-5.5.23-nts-x32.bat
@ECHO @ECHO ## the standard Windows CLI will not work         ##>> compile-php-5.5.23-nts-x32.bat
@ECHO @ECHO ####################################################>> compile-php-5.5.23-nts-x32.bat
@ECHO.>> compile-php-5.5.23-nts-x32.bat
@ECHO PAUSE>> compile-php-5.5.23-nts-x32.bat
@ECHO call .\bin\phpsdk_setvars.bat>> compile-php-5.5.23-nts-x32.bat
@ECHO CD .\phpdev\vc11\x86\php-5.5.23>> compile-php-5.5.23-nts-x32.bat
@ECHO nmake clean>> compile-php-5.5.23-nts-x32.bat
@ECHO call buildconf.bat --force>> compile-php-5.5.23-nts-x32.bat
@ECHO call configure %CFLAGS% --disable-zts>> compile-php-5.5.23-nts-x32.bat
@ECHO nmake snap>> compile-php-5.5.23-nts-x32.bat
@ECHO CD .\..\..\..\..\>> compile-php-5.5.23-nts-x32.bat
@ECHO PAUSE>> compile-php-5.5.23-nts-x32.bat

@ECHO @ECHO OFF> compile-php-5.5.23-ts-x32.bat
@ECHO @ECHO ####################################################>> compile-php-5.5.23-ts-x32.bat
@ECHO @ECHO ## Attention                                      ##>> compile-php-5.5.23-ts-x32.bat
@ECHO @ECHO ## please call this batch file with               ##>> compile-php-5.5.23-ts-x32.bat
@ECHO @ECHO ## Visual Studio 2012 Native Tools Command Prompt ##>> compile-php-5.5.23-ts-x32.bat
@ECHO @ECHO ## the standard Windows CLI will not work         ##>> compile-php-5.5.23-ts-x32.bat
@ECHO @ECHO ####################################################>> compile-php-5.5.23-ts-x32.bat
@ECHO.>> compile-php-5.5.23-ts-x32.bat
@ECHO PAUSE>> compile-php-5.5.23-ts-x32.bat
@ECHO call .\bin\phpsdk_setvars.bat>> compile-php-5.5.23-ts-x32.bat
@ECHO CD .\phpdev\vc11\x86\php-5.5.23>> compile-php-5.5.23-ts-x32.bat
@ECHO nmake clean>> compile-php-5.5.23-ts-x32.bat
@ECHO call buildconf.bat --force>> compile-php-5.5.23-ts-x32.bat
@ECHO call configure %CFLAGS%>> compile-php-5.5.23-ts-x32.bat
@ECHO nmake snap>> compile-php-5.5.23-ts-x32.bat
@ECHO CD .\..\..\..\..\>> compile-php-5.5.23-ts-x32.bat
@ECHO PAUSE>> compile-php-5.5.23-ts-x32.bat
